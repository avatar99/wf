...
client.on("message", message => {
    if (message.content.startsWith("لاّرو")) {
...
if(!message.author.id === '517694113190117386') return;
...
const developers = ["537672530438127626","id"]
client.on('message', message => {
  ...
  if (message.content.startsWith(adminprefix + 'stat')) {
...
client.login('NjE4ODA2MzE5NDA2Nzc2MzQy.XW_MeA.ylywScgZaFkvAApCm54Yw3-RbhY');